...
class NotificationPanel(ctk.CTkFrame):
    def __init__(
        self, master, manager, message, notify_type=NotifyType.INFO, duration=5000, bg_color="#dbdbdb", text_color="#262626", name: str = str(uuid4())
    ):
        ...
        self.close_button = ctk.CTkButton(
            ...
            width=15,
            height=15,
            command=self.remove_notification,
